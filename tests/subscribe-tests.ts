...
import { createAssociatedTokenAccount, createMint, getAssociatedTokenAddressSync, getOrCreateAssociatedTokenAccount, mintTo } from "@solana/spl-token";
...
describe("Subscription Tests", () => {
  ...
  const planInfos = [
    ...
    {
      chargeAmount: new anchor.BN(15 * 10 ** tokenDecimals),
      interval: new anchor.BN(3800), // 3600 seconds,
      tokenMint: mintKeyPair.publicKey,
      recipient: providerAta, // recipient is the provider ata
    }
  ];
